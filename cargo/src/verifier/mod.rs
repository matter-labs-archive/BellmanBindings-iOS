...
fn verify_with_precompiled_proof_with_certain_engine<E: Engine>(
...
#[no_mangle]
pub extern fn verify_with_precompiled_proof (
    file_with_vk: *const c_char,
    inputs_array: *const u8,
    inputs_array_size: usize,
    engine: EngineType, 
    ...
    match engine {
        EngineType::Bls12 => {
            println!("Bls12 curve");
            return verify_with_precompiled_proof_with_certain_engine::<Bls12>(
                file_with_vk,
                inputs_array,
                inputs_array_size,
                proof_vec, 
        ...
        EngineType::Bn256 => { 
            println!("Bn256 curve");
            return verify_with_precompiled_proof_with_certain_engine::<Bn256>(file_with_vk,
                inputs_array,
                inputs_array_size, 
                proof_vec, 
                proof_vec_size)
